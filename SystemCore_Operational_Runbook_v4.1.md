@@ -36,25 +36,175 @@ Tento runbook navazuje na v3.8.1 a doplňuje governance a auditní požadavky dl
...
| --- | --- | --- |
| CI/CD gating pro GDPR/A11y | Zařazeno do Governance & Compliance Gate | ⚙️ Částečně |
| Rollback scénáře a alert thresholdy | Definovány jako pending doplnění | ⚙️ Částečně |
| SLA metriky s konkrétními hodnotami | Vyžaduje doplnění z validačních reportů | ❌ Chybí |
...
## Appendix A — Source: SystemCore_Operational_Runbook.md (v3.8.1)
