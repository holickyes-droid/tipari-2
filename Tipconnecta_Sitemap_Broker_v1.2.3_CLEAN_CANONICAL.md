...
**Kontext:** V UI se sekce jmenuje **Tikety**. Interně jde o „Marketplace“ (standardní nabídka tiketů).

**Layout:** Hlavní navigace je v **horní liště (top nav)**, ne v sidebaru.

**Scope:** IA + sitemap + URL patterns (dev handoff) pro roli **Broker / Obchodnik**.  
**Kontext:** Labely v Mermaid jsou **ASCII-only** kvuli bezproblemovemu renderu v GitHub Preview.
...
### Hlídací pes (alerty)
- **LIST:** `/app/broker/watchdog`
- **DETAIL/EDIT:** `/app/broker/watchdog/:alertId`
...
### Podpora
- `/app/broker/support`
- `/app/broker/help/how-it-works` *(FAQ „Jak to funguje“ v aplikaci po přihlášení)*
...
- Galerie je **inline** v sekci projektu (hlavní obrázek + miniatury + šipky); nepoužíváme modal route.
